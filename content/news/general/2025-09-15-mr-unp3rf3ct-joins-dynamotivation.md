...
screenshot_urls = [
    ...
    "https://ucarecdn.com/af30c773-bf10-495b-b181-115f6fe5a3e0/GeoBackgroundGenerator.avif"
    ,
    "https://ucarecdn.com/702e2ffa-47d7-4f7f-9844-1197454c5cfc/OSSSpaceAdventure.avif",
    "https://ucarecdn.com/5bc20435-afe3-4f75-88eb-52a653bdcb0b/BenPlaysGamesSoundboard.avif"
]
+++
...
## Apps Joining the Dynamotivation Portfolio
...
<div class="blogImageList">
    <style>
        @media (max-width: 40rem) {
            .blogImageList { flex-direction: column; }
        }
    </style>
    <div>
        {{ screenshot(
            index=1,
            width="90%",
            description="**Joins the Battle Meme Generator**<br><br>A highly specialized image editor for the all-time classic fighting game character splash screens known from various game trailers. Primarily useful for creating memes, hoaxes, and concept mockups. Its functionality is unmatched in any dedicated editor for similar purposes.",
            radius="20%",
            figcaption="true",
            imageWidthPx=512,
            imageHeightPx=512
    ...
    <div>
        {{ screenshot(
            index=2,
            width="90%",
            description="**Geo Background Generator**<br><br>A specialized generator for aesthetic geometric background images composed of different shapes and satisfying gradients. Easy on the eye and rather boring by today's standards. Simplicity deserving of an upgrade.",
            radius="20%",
            figcaption="true",
            imageWidthPx=512,
            imageHeightPx=512
...
<div class="blogImageList">
    ...
    <div>
        {{ screenshot(
            index=3,
            width="90%",
            description="**O.S.S.: Space Adventure**<br><br>A straight forward arcade-style space shooter with zen music for calming and battery conserving gameplay. To this day its not known what O.S.S. stood for? 'Open Source Software'? Well, we'll see!",
            radius="20%",
            figcaption="true",
            imageWidthPx=512,
            imageHeightPx=512
    ...
    <div>
        {{ screenshot(
            index=4,
            width="90%",
            description="**BenPlaysGames Soundboard**<br><br>A soundboard of the British variety content creator BenPlaysGames. After surrendering their spot in culture to clips, shorts and supercuts, soundboards have become quite outdated.",
            radius="20%",
            figcaption="true",
            imageWidthPx=512,
            imageHeightPx=512
